...
Quote it. Translate it. Email it to a registry. Read it aloud at a standards
meeting. The whole point is that it spreads.

The site template (Hugo layouts, CSS, config) is separately licensed under MIT;
see `LICENSE`.
